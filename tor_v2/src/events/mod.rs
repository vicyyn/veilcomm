...
pub fn process_tor_event(
    ...
    std::thread::spawn(move || match tor_event {
        ...
        TorEvent::InitializePeer(side) => {
            ...
            let node7 = SocketAddrV4::new(Ipv4Addr::new(127, 0, 0, 1), 8006);
            create_circuit(0, tor_event_sender.clone(), node7, node6, node5);
        ...
        TorEvent::ConnectToPeer(side) => {
            ...
            let node5 = SocketAddrV4::new(Ipv4Addr::new(127, 0, 0, 1), 8005);
            create_circuit(0, tor_event_sender.clone(), node2, node3, node4);
            ...
            tor_event_sender
                .send(TorEvent::OpenStream(0, node5, 0))
                .unwrap();
            thread::sleep(time::Duration::from_millis(4000));
